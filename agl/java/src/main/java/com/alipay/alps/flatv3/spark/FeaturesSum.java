...
public class FeaturesSum extends Aggregator<FeaturesWeight, String, String> {
    ...
    public String merge(String b1, String b2) {
        String ret = "";
        try {
            ret = BaseEncoding.base64().encode(mergeFeature(Features.parseFrom(BaseEncoding.base64().decode(b1)), Features.parseFrom(BaseEncoding.base64().decode(b2))).toByteArray());
    ...
    public static Features updateFeature(Features a, float w) {
        ...
        for (Map.Entry<String, Features.DenseFeatures> entry : a.getDfsMap().entrySet()) {
            ...
            if (value.hasF32S()) {
                ...
                throw new RuntimeException("not supported node feature type: " + value.getClass().getName());
            }
        }
    ...
    public static Features mergeFeature(Features a, Features b) {
        ...
        for (Map.Entry<String, Features.SparseKVFeatures> entry : a.getSpKvsMap().entrySet()) {
            ...
            if (value.hasF32S()) {
                ...
                List<Float> f32sMerged = mergeFloatList(keysMerged, keysFromA, f32sFromA, keysFromB, f32sFromB);
                ...
                List<Double> f64sMerged = mergeFloatList(keysMerged, keysFromA, f64sFromA, keysFromB, f64sFromB);
                ...
                List<Long> i64sMerged = mergeFloatList(keysMerged, keysFromA, i64sFromA, keysFromB, i64sFromB);
    ...
    private static <T extends Number> List<T> mergeFloatList(List<Long> keysMerged, List<Long> keysFromA, List<T> valsFromA, List<Long> keysFromB, List<T> valsFromB) {
