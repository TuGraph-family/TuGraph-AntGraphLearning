...
public class WeightedSamplerTest {
  ...
  public void testSmallCandidateSizeWithoutReplacement() {
    ...
    AbstractResult indexResult = new RangeResult(weightIndex,
  ...
  public void testNoFilterSampleByWeightWithReplacement() {
    ...
    AbstractResult indexResult = new RangeResult(baseIndex,
        Collections.singletonList(candidateRange));
  ...
  public void testNoFilterSampleByWeightWithoutReplacementSmallSampleCount() {
    ...
    float[] expected = {0.019155F, 0.038025F, 0.058005F, 0.075135F, 0.09279F, 0.110305F, 0.12704F,
  ...
  public void testTypeFilterSampleByWeightWithReplacement() {
    ...
    SampleCondition sampleCondition = new SampleCondition(sampleMeta);
    WeightedSampler sampler = new WeightedSampler(sampleCondition, neighborDataset);
    AbstractResult indexResult = new RangeResult(typeIndex,
        Arrays.asList(new RangeUnit(0, 3), new RangeUnit(6, 9)));
  ...
  public void testWeightFilterSampleByWeightWithoutReplacementSmallSampleCount() {
    ...
    float[] expected = {0.0F, 0.04765F, 0.072515F, 0.094685F, 0.115405F, 0.13747F, 0.157795F,
  ...
  public void testNoFilterByWeightWithoutReplacement() {
    ...
    float[] expected = {0.020533F, 0.040367F, 0.060497F, 0.078057F, 0.095427F, 0.11189F, 0.127143F,
  ...
  public void testWeightFilterByWeightWithoutReplacement() {
    ...
    float[] expected = {0.0F, 0.0F, 0.08033F, 0.10474F, 0.126173F, 0.145977F, 0.164427F, 0.18205F,
        0.196303F, 0.0F};
    for (int i = 0; i < frequence.length; i++) {
      double empiricalProb = frequence[i] / (double) numSamples / 3.0;
      Assert.assertEquals(expected[i], empiricalProb, expected[i] * 0.1);
  ...
  public void testTypeTimeFilterByWeightWithoutReplacement() {
    ...
    float[] expected = {0.0496775F, 0.0F, 0.1312775F, 0.0F, 0.1828825F, 0.1978675F, 0.20961F, 0.0F,
        0.0F, 0.228685F};
    for (int i = 0; i < frequence.length; i++) {
