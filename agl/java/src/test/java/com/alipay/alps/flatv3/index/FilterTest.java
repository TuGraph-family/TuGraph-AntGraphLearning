...
public class FilterTest {
    ...
    public void testTwoRangeFilter() throws Exception {
        ...
        // Create a filter
        BaseIndex scoreIndex = new RangeIndex("range_index:score:float", neighborDataset);
        BaseIndex priceIndex = new RangeIndex("range_index:price:float", neighborDataset);
        Map<String, BaseIndex> indexMap = new HashMap<>();
        indexMap.put(scoreIndex.getIndexColumn(), scoreIndex);
        indexMap.put(priceIndex.getIndexColumn(), priceIndex);
