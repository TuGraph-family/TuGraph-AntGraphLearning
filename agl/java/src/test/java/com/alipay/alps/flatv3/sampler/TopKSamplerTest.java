...
public class TopKSamplerTest {
  ...
  public void setUp() {
    ...
    List<Float> weights = Arrays
        .asList(1.0F, 2.0F, 3.0F, 4.0F, 5.0F, 6.0F, 7.0F, 8.0F, 9.0F, 10.0F);
  ...
  public void testSmallCandidateSize() {
    AbstractResult indexResult = new RangeResult(typeIndex,
        Collections.singletonList(new RangeUnit(0, 3)));

    String sampleMeta = "topk(by=weight, limit=5, reverse=false, replacement=False)";
    TopKSampler<Float> sampler = new TopKSampler<>(new SampleCondition(sampleMeta),
        neighborDataset);
  ...
  public void testNoFilterSampleByTimestampReverse() {
    AbstractResult indexResult = new RangeResult(baseIndex,
        Collections.singletonList(new RangeUnit(0, 9)));
  ...
  public void testWeightFilterSampleByTimestamp() {
    AbstractResult indexResult = new RangeResult(weightIndex,
        Collections.singletonList(new RangeUnit(1, 8)));
  ...
  public void testTimeFilterSampleByTimestamp() {
    AbstractResult indexResult = new RangeResult(timeIndex,
        Collections.singletonList(new RangeUnit(1, 7)));
