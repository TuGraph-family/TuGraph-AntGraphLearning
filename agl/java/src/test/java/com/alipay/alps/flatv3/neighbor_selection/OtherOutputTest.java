...
public class OtherOutputTest {
  ...
  public void testNoFilterTopkSampler() throws Exception {
    ...
    NeighborSelector neighborSelector = new NeighborSelector(otherOutputSchema, filter,
    ...
    for (int seedIdx = 0; seedIdx < seedIds.size(); seedIdx++) {
      ...
      for (int i = 0; i < sampledNeighborIndex.size(); i++) {
        ...
        if (nodeOutputWidth == 0) {
          ...
          ans.add(
              new Object[]{seed, Constants.EDGE_INT, node1ID, node2ID, edgeID, null, null, null});
    ...
    expected.add(
        new Object[]{"s1", Constants.EDGE_INT, "currentNode", "n0", "e0", null, null, null, null});
    expected.add(new Object[]{"s1", Constants.NODE_INT, null, null, "n1", null, null, 2L, 1L});
    expected.add(
        new Object[]{"s1", Constants.EDGE_INT, "currentNode", "n1", "e1", null, null, null, null});
    expected.add(new Object[]{"s2", Constants.NODE_INT, null, null, "n0", null, null, 0L, 2L});
    expected.add(
        new Object[]{"s2", Constants.EDGE_INT, "currentNode", "n0", "e0", null, null, null, null});
    expected.add(new Object[]{"s2", Constants.NODE_INT, null, null, "n1", null, null, 2L, 2L});
    expected.add(
        new Object[]{"s2", Constants.EDGE_INT, "currentNode", "n1", "e1", null, null, null, null});
    expected.add(new Object[]{"s3", Constants.NODE_INT, null, null, "n0", null, null, 0L, 3L});
    expected.add(
        new Object[]{"s3", Constants.EDGE_INT, "currentNode", "n0", "e0", null, null, null, null});
    expected.add(new Object[]{"s3", Constants.NODE_INT, null, null, "n1", null, null, 2L, 3L});
    expected.add(
        new Object[]{"s3", Constants.EDGE_INT, "currentNode", "n1", "e1", null, null, null, null});
    expected.add(new Object[]{"s4", Constants.NODE_INT, null, null, "n0", null, null, 0L, 4L});
    expected.add(
        new Object[]{"s4", Constants.EDGE_INT, "currentNode", "n0", "e0", null, null, null, null});
    expected.add(new Object[]{"s4", Constants.NODE_INT, null, null, "n1", null, null, 2L, 4L});
    expected.add(
        new Object[]{"s4", Constants.EDGE_INT, "currentNode", "n1", "e1", null, null, null, null});
    expected.add(new Object[]{"s5", Constants.NODE_INT, null, null, "n0", null, null, 0L, 5L});
    expected.add(
        new Object[]{"s5", Constants.EDGE_INT, "currentNode", "n0", "e0", null, null, null, null});
