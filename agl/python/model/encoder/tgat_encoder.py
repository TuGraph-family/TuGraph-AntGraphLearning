...
class TGATEncoder(AGLAlgorithm):
    def __init__(self, n_feat, e_feat, feat_dim, num_layers=2, n_head=4, drop_out=0.1, num_ngh=10):
        super().__init__()
    ...
    def tem_conv(self, node_indices: np.ndarray, curr_times,
        ...
        if curr_layers == 0:
            ...
            ngh_node_indices, ngh_node_ids, ngh_edge_ids, ngh_edge_times = self.get_temporal_neighbor(
    ...
    def encode(self, subgraph: TorchSubGraphBatchData, node_raw_embed, edge_raw_embed, **kwargs):
        ...
        root_embed = self.tem_conv(
                root_idx, cut_time, n_feats, e_feats, node_raw_embed,
                edge_raw_embed, adj, self.num_layers)
