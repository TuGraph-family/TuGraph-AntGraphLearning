...
def read_lastfm():
    ...
    print("edge num: {}, distinct user num: {}, distinct item num: {}".format(len(edges), len(set(edges[:, 0])), len(set(edges[:, 1]))))
    ...
    print("social_relations num: {}, distinct user num: {}".format(len(social_relations), len(set(social_relations[:, 0])|set(social_relations[:, 1]))))
