...
/ossfs/workspace/merit_model_test/data_process/spark-3.1.1-odps0.34.1/bin/spark-submit --master local --class com.alipay.alps.flatv3.spark.DynamicGraph \
    ...
    input_edge='file:////ossfs/workspace/merit_model_test/data_process/wiki_data2/full_edge_table.csv' \
    ...
    input_label='file:////ossfs/workspace/merit_model_test/data_process/wiki_data2/full_seed_table.csv' \
    ...
    output_results='file:////ossfs/workspace/merit_model_test/data_process/wiki_data2/full_output_wikipedia' | tee logfile.txt
